totaltipodocumento();
function totaltipodocumento(){
  
  $.ajax({
    url: "../ajax/totaltipodocumento",
    data: {
      code: '0'
    },
      ...
      for (var i = 0; i < result.length; i++) {
        car += '<div class="widget_summary">'
				  car += '<div class="w_left w_55">'
					  car += '<span>'+result[i].acronimoDoc+'</span>'
				  car += '</div>'
